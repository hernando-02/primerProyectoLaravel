                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-12 d-flex flex-wrap">
                        <p class="d-flex me-4 mb-0">
                            ...
                            <strong class="text-dark">Bienvenido a Music Festival 2023</strong>
                        </p>
                    </div>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav align-items-lg-center ms-auto me-lg-5">
                        ...
                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="#section_3">Artistas</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="#section_4">Horario</a>
                        </li>
                    ...
                    <a href="ticket.html" class="btn custom-btn d-lg-block d-none">Comprar boletos</a>
                </div>
            </div>
        </nav>
            ...
            <div class="container d-flex justify-content-center align-items-center">
                <div class="row">
                    ...
                    <div class="col-12 mt-auto mb-5 text-center">
                        <small>Festava Live Presenta</small>
                    ...
                    <div class="col-lg-12 col-12 mt-auto d-flex flex-column flex-lg-row text-center">
                        <div class="date-wrap">
                            <h5 class="text-white">
                                ...
                                10 - 12<sup>th</sup>, Diciembre 2023
                            </h5>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12 mb-4 mb-lg-0 d-flex align-items-center">
                        <div class="services-info">
                            <h2 class="text-white mb-4">Acerca del festival 2022</h2>

                            <p class="text-white">Vive la magia de un festival inolvidable: música, risas, arte y diversión se fusionan en un solo lugar. Sumérgete en un mar de emociones, descubre nuevos talentos y celebra la vida al ritmo de la música.</p>
                        </div>
                    </div>
                        ...
                        <div class="about-text-wrap">
                            ...
                            <div class="about-text-info d-flex">
                                ...
                                <div class="ms-4">
                                    ...
                                    <p class="mb-0">tu increíble experiencia festivalera con nosotros</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="col-12 text-center">
                        <h2 class="mb-4">Conoce a los artistas</h1>
                    </div>
        ...
        <section class="schedule-section section-padding" id="section_4">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 text-center">
                        <h2 class="text-white mb-4">Horario del Evento</h1>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-12 mx-auto">
                        <h2 class="text-center mb-4">Planes que amas</h2>
                    </div>
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="pricing-thumb">
                            <div class="d-flex">
                                <div>
                                    <h3><small>Madrugador</small> $120.000</h3>

                                    <p>Incluyendo cosas buenas:</p>
                                </div>

                                <p class="pricing-tag ms-auto">Ahorra hasta <span>50%</span></h2>
                            </div>
                    ...
                    <div class="col-lg-6 col-12 mt-4 mt-lg-0">
                        <div class="pricing-thumb">
                            <div class="d-flex">
                                <div>
                                    <h3><small>Estándar</small> $240.000</h3>

                                    <p>¿Qué hace un festival premium?</p>
                                </div>
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-12 mb-4 pb-2">
                    ...
                    <ul class="site-footer-links">
                        ...
                        <li class="site-footer-link-item">
                            <a href="#" class="site-footer-link">Artistas</a>
                        </li>
                ...
                <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0">
                    <h5 class="site-footer-title mb-3">¿Tines alguana pregunta?</h5>
